...
from utils_unet_wind import train_epoch, eval_epoch
# , test_epoch
...
model = U_net(input_channels=input_length * 3, output_channels=3, kernel_size=kernel_size,
...
for i in range(30):
    ...
    if valid_mse[-1] < min_mse:
        ...
        torch.save(best_model, "unet_model_wind.pth")
    end = time.time()
